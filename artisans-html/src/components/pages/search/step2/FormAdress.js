  ...
  render() {
    ...
    return (
      <div className="addresse-form-panel">
        <TextField value={this.state.position.codepostal} fullWidth={true} className="adresse-form-textfield"
        ...
        <TextField fullWidth={true} onChange={this.handleChange('commune')} floatingLabelText="Commune"
                   value={this.state.position.commune}   className="adresse-form-textfield" errorText={errorCommune}/>
        <TextField fullWidth={true} onChange={this.handleChange('rue')} floatingLabelText="Rue / Lieu dit"
                   value={this.state.position.rue}  className="adresse-form-textfield" multiLine={true}/>
